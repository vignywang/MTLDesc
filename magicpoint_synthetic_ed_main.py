...
from utils.megpoint_trainers import MagicPointEncoderDecoderTrainer
...
class MagicPointEncoderDecoderParameters(BasicParameters):

    def __init__(self):
        super(MagicPointEncoderDecoderParameters, self).__init__()
...
def main():
    ...
    params = MagicPointEncoderDecoderParameters()
    params.initialize()

    magicpoint_synthetic = MagicPointEncoderDecoderTrainer(params)
