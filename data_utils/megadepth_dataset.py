...
class MegaDetphDatasetCreator(object):
    ...
    def __init__(
        ...
        self.grid = self._generate_fixed_grid(self.image_size, self.image_size)
    ...
    def recover_pair(
        ...
        desp_point1 = self._scale_point_for_sample(desp_point1, self.image_size, self.image_size)
        desp_point2 = self._scale_point_for_sample(desp_point2, self.image_size, self.image_size)
