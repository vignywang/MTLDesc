...
from nets.affnet_utils.Utils import L2Norm, generate_2dgrid
from nets.affnet_utils.Utils import str2bool
from nets.affnet_utils.LAF import denormalizeLAFs, LAFs2ell, abc2A, extract_patches,normalizeLAFs,  get_rotation_matrix
from nets.affnet_utils.LAF import get_LAFs_scales, get_normalized_affine_shape
from nets.affnet_utils.LAF import rectifyAffineTransformationUpIsUp,rectifyAffineTransformationUpIsUpFullyConv
