...
% Methods = {'mlifeat128megacoco0.9_0.90'};
% Methods = {'mlifeat128megacoco09_0.80', 'mlifeat128megacoco08_0.80', 'mlifeat128megacoco07_0.80', 'mlifeat128megacoco06_0.80', 'mlifeat128megacoco05_0.80', 'mlifeat128megacoco04_0.80', 'mlifeat128megacoco03_0.80', 'mlifeat128megacoco02_0.80', 'mlifeat128megacoco01_0.80'};
% Methods = {'superpointselftrained30_0.80'};
% Methods = {'superpointselftrained15_0.80'};
% Methods = {'superpointselftrained30_0.80', 'mlifeat128megacoco08_0.80', 'mlifeat128megacoco04_0.80'};
% Methods = {'aslfeat_0.80'};
Methods = {'dspsift_0.80'};
disp('Evaluation...')
...
for d = 1 : length(Datasets) 
    ...
    for m = 1 : length(Methods)
       ...
       [meanNumbers] = mean(Numbers{m,d});
       before_number = meanNumbers(1);
       after_number = meanNumbers(2);
       
       fprintf(sprintf('%s %f %f %f %f %f\n', method, recall, after_rate, before_rate, after_number, before_number));
    end 
end
