...
from nets.MLIFeat_net import SuperPointNetDescriptor


class SuperpointFsm(object):

    def __init__(self,  **config):
        self.name = 'superpoint_fsm'
        self.config = {
        ...
        # 初始化resnet18_fast
        print("Initialize descriptor + fsm")
        self.model = SuperPointNetDescriptor().to(self.device)
